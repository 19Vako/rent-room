  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={handleViewRoom} className="text-white hover:text-gray-200 ml-1" title="View property on site">
          ...
          <div className="border-t border-gray-200 bg-gray-50">
            ...
            >
              <div className="w-11 h-11 rounded-full shrink-0 border border-dashed border-[#006CE4] flex items-center justify-center bg-white">
                <svg className="w-5 h-5 text-[#006CE4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path>
                </svg>
              </div>
              <div>
                <p className="font-bold text-[15px]">Add new room</p>
                <p className="text-[13px] text-gray-500 font-normal">Create listing</p>
              </div>
            </Link>
          </div>
