...
export default function CalendarDayCell({ day, firstDay, price, isSelected, event, onClick }: {
  day: number;
  firstDay: number;
  price?: number;
  isSelected: boolean;
    ...
    >
      ...
      {!event && (
        <div className="flex-1 flex flex-col items-center justify-center p-2 opacity-80">
          <span className="text-xs text-green-600 mb-1 font-medium">Available</span>
          <span className="text-sm font-semibold text-black">UAH {price || 0}</span>
        </div>
      )}
