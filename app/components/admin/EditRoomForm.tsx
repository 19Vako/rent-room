...
import { updateRoom, deleteRoom } from "@/lib/actions/room.actions";
...
export default function EditRoomForm({ initialRoom }: { initialRoom: Room }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage({ type: "success", text: "Room settings saved successfully!" });
          ...
          <div className="flex flex-col lg:flex-row gap-8 w-full">
            ...
            <div className="flex-1 flex flex-col gap-4 bg-white p-6 rounded-lg shadow-sm border border-gray-200 h-fit">
              ...
              <div className="border border-gray-200 bg-white p-6 rounded shadow-sm">
                <h2 className="text-xl font-bold mb-6 text-gray-900">Room Settings</h2>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-gray-500 mt-1">This is the category guests will see on the website.</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-[12px] text-gray-500 mt-1">Number of guests this room can accommodate.</p>
                  </div>
                  ...
                  {/* MESSAGE BOX */}
                  {message && (
                    <div className={`p-3 rounded text-[14px] ${message.type === 'success' ? 'bg-green-50 border border-green-200 text-green-800' : 'bg-red-50 border border-red-200 text-red-800'}`}>
                      {message.text}
                    </div>
                  )}
              ...
              <div className="border border-red-200 bg-red-50 p-6 rounded shadow-sm">
                <h2 className="text-lg font-bold mb-2 text-red-800">Danger Zone</h2>
                <p className="text-[13px] text-red-600 mb-4">Once you delete a room, there is no going back. Please be certain.</p>
                <button 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm transition-opacity">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-600 mb-6 text-[14px]">
              Are you sure you want to delete <span className="font-bold">{initialRoom.roomName}</span>? This action is permanent and cannot be undone.
            </p>
