...
import { getUserOrders } from "@/src/lib/actions/order.actions";
import { auth } from "@/src/auth/auth";
import OrderList from "../../../src/components/shared/OrderList";
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="px-4 md:px-10 -mt-10">
        <div className="max-w-6xl mx-auto bg-white p-6 md:p-10 rounded-lg shadow-xl min-h-[400px]">
          <BackButton />
          <h2 className="text-2xl mt-8 font-bold text-gray-900 mb-8">
            Your Bookings
          </h2>
