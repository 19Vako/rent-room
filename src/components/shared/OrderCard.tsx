...
import { cancelOrder } from "@/src/lib/actions/order.actions";
        ...
        <div className="flex flex-wrap justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3">
              <span
                className={`px-3 py-1 text-xs font-semibold rounded-full ${currentStatus.colors}`}
              >
                {currentStatus.label}
              </span>
            ...
            <p className="text-base text-black mt-3 font-semibold group-hover:text-[#0071c2] transition-colors">
              Check-in:{" "}
              {new Date(order.checkInDate).toLocaleDateString("en-US")} —
              Check-out:{" "}
              {new Date(order.checkOutDate).toLocaleDateString("en-US")}
            </p>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`px-3 py-1 text-xs text-black font-semibold rounded-full ${currentStatus.colors}`}
                >
                  {currentStatus.label}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pt-2 border-t text-lg">
                ...
                <span className="font-extrabold text-[#0071c2]">
                  UAH {order.price.toLocaleString("en-US")}
                </span>
              </div>
            </div>
